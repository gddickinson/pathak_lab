...
class JoinTracks():
    def __init__(self):
        #training data path
        self.train_data_path = '/Users/george/Data/from_Gabby/gabby_scripts/workFlow/training_data/tdTomato_37Degree_CytoD_training_feats.csv'
    ...
    def predict_SPT_class(self, train_data_path, df, exptName, level):
    ...
    def join(self, df, IDlist):
        ...
        for trackIDs in IDlist:
            ...
            '''This is slow''' #TODO!
            svmDF = self.predict_SPT_class(self.train_data_path, rgDF, str(df['Experiment'][0]), level='')
